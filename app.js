...
<form id="frm" action="/pred" method="POST">
    <input class="ipt" type="text" placeholder="age" name="age"><br>
    <input class="ipt" type="text" placeholder="weight" name="weight"><br>
    <input class="ipt" type="text" placeholder="age" name="age"><br>
    <input class="ipt" type="text" placeholder="weight" name="weight"><br>
...
&copy;2020 developed by Shivam Jadhav
    ...
    <input class="ipt" type="text" placeholder="height in ft" name="height" maxlength="3"  required><br>
    <input class="ipt" type="text" placeholder="weight" name="weight" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br>
    <input class="ipt" type="text"  placeholder="Enter successfields baskets /(100)" name="successfields" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br>
    <input class="ipt" type="text"   placeholder="Enter success free throws /(100)" name="successfree" maxlength="2" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required><br>
